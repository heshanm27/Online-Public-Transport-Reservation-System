...
$sql = "SELECT * FROM trainseat LEFT JOIN train ON train.TrainID = trainseat.trainID where trainseat.pName='$name'";
...
<td class="title" >Train Starting Point</td>
<td><?php echo $dbtspoint?></td>
</tr>
<tr>

    <td class="title" >Train End Point</td>
    <td><?php echo $dbtepoint?></td>
    </tr>
    <tr>

    <td class="title" >Train Starting Time And Date</td>
    <td><?php echo $dbdate.'('.$dbtime.')'?></td>
    </tr>
     <tr>

    <td class="title" >Number of Reserved Ticket </td>
