...
<li><a href="../../userselectlogin.html" style="color:orange;">Log In</a>
    ...
    <ul id="drop3">
    <li><a href="profile.php" style="color:orange;">Owner Profile</a>
 ...
 <!--Navigation bar End-->
    ...
    <div id="content">
        ...
        <div id="rightBox" >
            ...
            <div class="input">
                <!--Form-->
                <form action="../Busowner/regData.php" id="subForm"  method="POST" enctype="multipart/form-data">
                   <!--left div with image-->
                    <div id="left">
                        <div id="uimg">
                ...
                <!--Input Nic-->
                <label>NIC-:</label>
                <input type="text" id="Nic" name="nic" class="check" placeholder="Enter NIC" required oninvalid="this.setCustomValidity('Please Enter NIC')" oninput="this.setCustomValidity('')">
