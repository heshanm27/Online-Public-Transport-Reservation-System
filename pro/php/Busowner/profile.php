...
<li><a href="../CrudOperation/logout.php">LogOut</a>
...
<!--Third Drop Down Menu-->
 ...
 <div id="mySidenav" class="sidenav">
  ...
  <?php echo "<a href='busupdate.php?id=$id'>Update Bus Details</a>"?>
  <a href="BusRegistrationmain.php">Register Bus</a>
...
$user = $_SESSION["OwID"];
    ...
    require '../config.php';
    $sql = "select * from busowner WHERE OwID='".$user."'";
...
<!--dynamic profile image-->
     <div id="logo"><img src="../uploads/<?php echo $dbimage?> "id ="userlogo"></div>
     <!--dynamic -->
     <div id="tabel">
